// typedefs borrowed from bun repo https://github.com/oven-sh/bun/tree/main/packages/bun-types,
// because JSR dock/bundling struggles with simple import {} from "bun" :/
 ...
 */
function readableStreamToBytes(stream: ReadableStream<ArrayBufferView | ArrayBufferLike>): Promise<Uint8Array> | Uint8Array;
 ...
 */
const hash: ((data: string | ArrayBufferView | ArrayBuffer | SharedArrayBuffer, seed?: number | bigint) => number | bigint) &
	Hash;
...
interface WebSocketServeOptions<WebSocketDataType = undefined> extends GenericServeOptions {
	 ...
	 * Respond to {@link Request} objects with a {@link Response} object.
	 */
	fetch(this: Server, request: Request, server: Server): Response | undefined | void | Promise<Response | undefined | void>;
}
...
interface TLSWebSocketServeOptions<WebSocketDataType = undefined> extends WebSocketServeOptions<WebSocketDataType>, TLSOptions {
	unix?: never;
...
class CryptoHasher {
	 ...
	 * @param encoding `DigestEncoding` to return the hash in
	 */
	static hash(algorithm: SupportedCryptoAlgorithms, input: Bun.BlobOrStringOrBuffer, encoding: DigestEncoding): string;
...
interface ZlibCompressionOptions {
	 ...
	 */
	windowBits?: -9 | -10 | -11 | -12 | -13 | -14 | -15 | 9 | 10 | 11 | 12 | 13 | 14 | 15 | 25 | 26 | 27 | 28 | 29 | 30 | 31;
	/**
